...
export function DerechosSection({
  ...
  const action = subirReciboDerechosAction.bind(null, casoId);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-xs text-ink/40">
        Comprobantes de pago de derechos/cuotas de gobierno pagados en el
        banco (foto o PDF). Máximo 15 MB por archivo.
      </p>
    </div>
  );
}
